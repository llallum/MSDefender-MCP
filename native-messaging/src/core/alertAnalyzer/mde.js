...
//            console.log(err);
    ...
    async getDeviceSoftwareInventory(deviceId, pageIndex=1, pageSize=100){
        //Product Code CPE
        ...
        const endpoint = BASE_URL + ENDPOINTS.DEVICE_SOFTWARE_INVENTORY.replace("{deviceId}", deviceId);
